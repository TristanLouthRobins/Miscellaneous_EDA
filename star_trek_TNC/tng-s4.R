...
# Latest update: v1.02 (30 June 2023) ------------------------------------------
library(tidyverse)
...
images_tng <- c(
  "images/headshots/tng-s4/barclay.jpg",
  "images/headshots/tng-s4/bcrusher.jpg",
  "images/headshots/tng-s4/brahms.jpg",
  "images/headshots/tng-s4/data.jpg",
  "images/headshots/tng-s4/guinan.jpg",
  "images/headshots/tng-s4/laforge.jpg",
  "images/headshots/tng-s4/obrien.jpg",
  "images/headshots/tng-s4/other.jpg",
  "images/headshots/tng-s4/picard.jpg",
  "images/headshots/tng-s4/riker.jpg",
  "images/headshots/tng-s4/troi.jpg",
  "images/headshots/tng-s4/wcrusher.jpg",
  "images/headshots/tng-s4/worf.jpg"
)

# apply cropcircles to create circular images representing MVCs ----------------
image_df <- tibble(y = 1:13, images = images_tng) %>% 
...
MVC_leaderboard <- 
  ...
  mutate(img = ifelse(Character == "BARCLAY", images[1], 
                      ifelse(Character == "B.CRUSHER", images[2], 
                             ifelse(Character == "LEAH BRAHMS", images[3],
                                    ifelse(Character == "DATA", images[4],
                                           ifelse(Character == "GUINAN", images[5], 
                                                  ifelse(Character == "LA FORGE", images[6], 
                                                         ifelse(Character == "O'BRIEN", images[7], 
                                                                ifelse(Character == "NOBODY", images[8], 
                                                                       ifelse(Character == "PICARD", images[9], 
                                                                              ifelse(Character == "RIKER", images[10],
                                                                                     ifelse(Character == "TROI", images[11],
                                                                                            ifelse(Character == "W.CRUSHER", images[12],
                                                                                                   ifelse(Character == "WORF", images[13],
                                                                                                          images[13]))))))))))))))
...
ggsave("exports-tng-s4/tng-final_s4_scores.png",width = 48, height = 24, units = "cm", dpi=100) 
...
MVC_leaderboard <- MVC_leaderboard %>% 
  mutate(div_col = ifelse(Character %in% c("PICARD", "RIKER", "SHELBY", "W.CRUSHER"), '#CD6363', # Command
                          ifelse(Character %in% c("DATA", "O'BRIEN", "WORF", "LA FORGE", "BARCLAY"), '#B5A424', # Ops / Security
...
sel_chr <- c("BARCLAY", "B.CRUSHER", "LEAH BRAHMS", "DATA", "GUINAN", "LA FORGE", "O'BRIEN", "NOBODY", "PICARD", "RIKER", "TROI", "W.CRUSHER", "WORF")
...
MVC_ranks_plt <- hlt_rank_plt(sel_chr <- c("B.CRUSHER"))
...
ggsave("exports-tng-s4/tng_s4_MVC-wotitle.png",width = 48, height = 24, units = "cm", dpi=100) 
...
ggsave("exports-tng-s4/tng-final_s4_cluster.png", width = 36, height = 24, units = "cm", dpi=100) 
ggsave("exports-tng-s4/tng-final_s4_cluster-square.png", width = 36, height = 36, units = "cm", dpi=100) 
...
all_rating_plt <- 
  ...
  geom_text(aes(x=Weighted - 1, y=fct_reorder(Episode_name, Episode_number), label = round(Weighted,1)), family="Antonio", colour = "#000000", size = 6) +
  #  geom_vline(xintercept = summary_stats$mean[2], colour = "#FFCC33", size = 1, alpha = 0.7) +
  labs(
...
ggsave("exports-tng-s4/final_s4_all_scores.png",width = 24, height = 24, units = "cm", dpi=100) 
...
ggsave("exports-tng-s4/final_s4_all_order_by_scores.png",width = 24, height = 24, units = "cm", dpi=100) 
...
top_TNC <- top3(4,TNC,"TNC")
top_IMDB <- top3(4,IMDB,"IMDB")
top_Andy <- top3(4,Andy_rating,"Andy_rating")
top_Matt <- top3(4,Matt_rating,"Matt_rating") 
...
ggsave("exports-tng-s4/top_3_scores_facet.png",width = 24, height = 8, units = "cm", dpi=100) 
...
ggsave("exports-tng-s4/top_episode.png",width = 12, height = 12, units = "cm", dpi=100) 
...
# set up a base layer --
title <- "STAR TREK: THE NEXT CONVERSATION - THE NEXT GENERATION: SEASON 4"
...
ggsave("exports-tng-s4/tnc_tng_s4.png", plot = tnctngs3plt, width = 80, height = 60, units = "cm", dpi = 100) 
