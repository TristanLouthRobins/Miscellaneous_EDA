...
var.cmd <- c("Picard", "Riker", "Ensign Gibson")
var.ops <- c("O'Brien", "Data", "Worf", "Geordi")
...
images_tng <- c(
  "star_trek_TNC/images/headshots/tng-s2/picard.jpg",
  "star_trek_TNC/images/headshots/tng-s2/riker.jpg",
  "star_trek_TNC/images/headshots/tng-s2/data.jpg",
  "star_trek_TNC/images/headshots/tng-s2/worf.jpg",
  "star_trek_TNC/images/headshots/tng-s2/gibson.jpg",
  "star_trek_TNC/images/headshots/tng-s2/pulaski.jpg",
  "star_trek_TNC/images/headshots/tng-s2/wcrusher.jpg",
  "star_trek_TNC/images/headshots/tng-s2/troi.jpg",
  "star_trek_TNC/images/headshots/tng-s2/laforge.jpg",
  "star_trek_TNC/images/headshots/tng-s2/obrien.jpg",
  "star_trek_TNC/images/headshots/tng-s2/other.jpg"
)
...
sub_title <- glue("MVC VOTE LEADERBOARD ({eps_watched}/22 EPISODES)")
...
MVC_leaderboard <- MVC_leaderboard %>% 
  mutate(div_col = ifelse(Character %in% c("PICARD", "RIKER", "LA FORGE", "ENSIGN GIBSON"), '#CD6363', # Command
                          ifelse(Character %in% c("DATA", "O'BRIEN", "WORF"), '#B5A424', # Ops / Security
                                 ifelse(Character %in% c("PULASKI", "TROI"), '#3399FF', '#4C4D47')))) # Sciences, if not: Civilian/Other
...
(MVC_plt <- 
    ...
    labs(
      ...
      x = element_blank(),
      y = element_blank()) +
    scale_x_continuous(limits = c(0, 10), breaks = c(1,2,3,4,5,6,7,8,9)) +
    theme_trek() +
...
sel_chr <- c("PICARD", "W.CRUSHER", "TROI", "NOBODY", "ENSIGN GIBSON", "O'BRIEN", "DATA", "PULASKI", "WORF", "LA FORGE", "RIKER")
...
sub_title <- glue("MVC VOTE RANKING TREND ({eps_watched}/22 EPISODES)")
...
hlt_rank_plt <- function(selection){
  ...
  ggplot() +
    ...
    scale_x_continuous(limits = c(0, 23), breaks = c(1:22)) 
} 

# MVC_plt - highlight the top 3 MVCs for this season -----
MVC_ranks_plt <- hlt_rank_plt(c("PICARD", "PULASKI"))
...
cluster_plot <- 
  ...
  annotate("text", x=3, y=3, size = 8, colour = cluster_txtcol, label = "CRUSHED IT", fontface = 2, family = "Antonio") +
...
ggsave("star_trek_TNC/exports-tng-s2/tnc_tng_s2.png", plot = tnctngs2plt, width = 80, height = 60, units = "cm", dpi = 100) 
