...
# Season 6 (26 episodes in total) ----------------------------------------------
# Latest update: v1.02 (22 August 2023) ------------------------------------------
library(tidyverse)
...
ggsave("exports-tng-s6/tng-final_s6_scores.png",width = 48, height = 24, units = "cm", dpi=100) 
...
k_data <- data %>% slice(0:26) %>%  select("Episode_name", "Matt_rating", "Andy_rating", "TNC", "IMDB")
episodes <- k_data[,1]
...
ggsave("exports-tng-s6/tng-final_s6_cluster.png", width = 36, height = 24, units = "cm", dpi=100) 
ggsave("exports-tng-s6/tng-final_s6_cluster-square.png", width = 36, height = 36, units = "cm", dpi=100) 
...
ggsave("exports-tng-s6/final_s6_all_scores.png",width = 24, height = 24, units = "cm", dpi=100) 
...
ggsave("exports-tng-s6/final_s6_all_order_by_scores.png",width = 24, height = 24, units = "cm", dpi=100) 
...
top_TNC <- top3(6,TNC,"TNC")
top_IMDB <- top3(6,IMDB,"IMDB")
top_Andy <- top3(6,Andy_rating,"Andy_rating")
top_Matt <- top3(6,Matt_rating,"Matt_rating") 
...
ggsave("exports-tng-s6/top_3_scores_facet.png",width = 24, height = 8, units = "cm", dpi=100) 
...
ggsave("exports-tng-s6/top_episode.png",width = 12, height = 12, units = "cm", dpi=100) 
